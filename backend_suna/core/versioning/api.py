...
@router.get("/agents/{agent_id}/versions", response_model=List[VersionResponse], summary="List Agent Versions",
...
@router.post("/agents/{agent_id}/versions", response_model=VersionResponse, summary="Create Agent Version",
...
@router.get("/agents/{agent_id}/versions/{version_id}", response_model=VersionResponse, summary="Get Agent Version",
...
@router.put("/agents/{agent_id}/versions/{version_id}/activate", summary="Activate Agent Version",
            operation_id="activate_agent_version")
...
@router.get("/agents/{agent_id}/versions/{version1_id}/compare/{version2_id}", response_model=VersionComparisonResponse,
            summary="Compare Agent Versions", operation_id="compare_agent_versions")
...
@router.post("/agents/{agent_id}/versions/{version_id}/rollback", response_model=VersionResponse,
             summary="Rollback to Agent Version", operation_id="rollback_to_agent_version")
...
@router.put("/agents/{agent_id}/versions/{version_id}/details", response_model=VersionResponse,
            summary="Update Agent Version Details", operation_id="update_agent_version_details")
